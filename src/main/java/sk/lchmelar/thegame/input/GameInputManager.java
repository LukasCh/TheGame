...
public class GameInputManager {
	...
	public void handleInput() {
		...
		if(isPressed(LMB)) {
			theGame.getGameWorld().addEntity(((Actor)theGame.getGameWorld().getLocalPlayer()).shoot(theGame.getGraphicsRenderer().getViewport().getX() + getMouseX(), theGame.getGraphicsRenderer().getViewport().getY() + getMouseY()));
		}
	}
